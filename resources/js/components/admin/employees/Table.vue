...
const ViewUser = defineAsyncComponent(() => import("./View.vue"));
const CreateUser = defineAsyncComponent(() => import("./Create.vue"));
const EditUser = defineAsyncComponent(() => import("./Edit.vue"));
const DeleteUser = defineAsyncComponent(() => import("./Delete.vue"));
        ...
        <div class="px-4 lg:px-12">
            <div class="bg-white dark:bg-gray-800 relative sm:rounded-lg overflow-hidden">
                ...
                >
                    ...
                    <CreateUser @record-created="handleRecords" />
                </div>
                    ...
                    >
                        ...
                        <tbody>
                            ...
                            >
                                <th
                                    scope="row"
                                    class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white capitalize flex items-center"
                                >
                                    {{ record.name }}
                                </th>
                                <td
                                ...
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <div class="inline-flex rounded-md shadow-sm" role="group">
                                        <ViewUser :id="record.id" />
                                        <EditUser :id="record.id" @record-updated="handleRecords" />
                                        <DeleteUser :id="record.id" @record-deleted="handleRecords" />
                                    </div>
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <ul class="inline-flex items-stretch -space-x-px">
                        <li>
                            <button
                                ...
                                :class="records.links.prev ? '' : 'cursor-not-allowed'"
                        ...
                        <li v-for="link in links" :key="link.label">
                            <button
                                ...
                                :class="link.active ? 'bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-white' : 'text-gray-500 bg-white dark:text-gray-400 dark:hover:bg-gray-700'"
                            >
                                {{ link.label }}
                            </button>
                        </li>
                        ...
                        <li>
                            <button
                                ...
                                :class="records.links.next ? '' : 'cursor-not-allowed'"
