...
const ViewTask = defineAsyncComponent(() => import("./View.vue"));
const CreateTask = defineAsyncComponent(() => import("./Create.vue"));
const EditTask = defineAsyncComponent(() => import("./Edit.vue"));
const DeleteTask = defineAsyncComponent(() => import("./Delete.vue"));

const { allRecord } = useAllRecord("/api/admin/tasks");
        ...
        <div class="px-4 lg:px-12">
            ...
            >
                ...
                >
                    ...
                    <CreateTask @record-created="handleRecords" />
                </div>
                            ...
                            >
                                ...
                                <td class="px-4 py-3">
                                    <span
                                        ...
                                        class="px-3 py-1 rounded text-white capitalize"
                                    >
                                        {{ record.priority }}
                                    </span>
                                </td>
                                <td class="px-4 py-3">
                                    <span
                                        ...
                                        class="py-1 px-3 rounded text-white capitalize"
                                    >
                                        {{ record.status }}
                                    </span>
                                </td>
