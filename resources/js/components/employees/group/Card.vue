            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                <li class="inline-flex items-center" aria-current="page">
                    <a href="#" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white uppercase">
                        <img src="/resources//js/assets/icons/group.svg" class="w-4 h-4">
                        Groups
                    </a>
                </li>
            </ol>
        ...
        <div>
            <div class="px-4 lg:px-12">
                <div class="grid grid-cols-2 gap-5">
                    <div v-for="group in groups" :key="group.id" class="w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                        ...
                        <div class="flex flex-col gap-3">
                            <p class="font-normal bg-gray-700 text-white inline-block px-3 py-2 rounded">
                                Group Tasks
                            </p>
